...
public class InfiniteScrollingBehaviour: NSObject {
    ...
    public init(withCollectionView collectionView: UICollectionView,
                andData dataSet: [InfiniteScollingData], delegate: InfiniteScrollingBehaviourDelegate,
...
extension InfiniteScrollingBehaviour: UICollectionViewDelegateFlowLayout {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        delegate?.didSelectItem(collectionView: collectionView, atIndexPath: indexPath,
                                originalIndex: originalIndex, andData: dataSetWithBoundary[indexPath.item],
...
extension InfiniteScrollingBehaviour: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView,
        ...
        let originalIndex = indexInOriginalDataSet(forIndexInBoundaryDataSet: indexPath.item)
        return delegate.configuredCell(collectionView: collectionView,
                                       forItemAtIndexPath: indexPath, originalIndex: originalIndex,
